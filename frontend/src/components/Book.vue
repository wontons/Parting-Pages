<template>
  <div class="flex justify-center items-center bg-purple-700 rounded border m-4" @click="parentValue = true">
    ...
    <div class="bg-gray-300 flex-col items-center rounded-lg border shadow overflow-hidden w-1/2 mt-8 hover:bg-white">
      ...
      <div class="flex m-2">
        <button class="flex w-1/2 justify-center items-center bg-orange-400 text-white font-bold rounded bordered hover:bg-orange-600 p-2 m-2" @click="learn">
          <span>More info</span>
        ...
        <button class="flex w-1/2 justify-center items-center bg-green-400 text-white font-bold rounded bordered hover:bg-green-600 p-2 m-2" @click="learn">
